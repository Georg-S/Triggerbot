...
bool MemoryReader::attach_to_process(const char* window_name)
{
...
DWORD MemoryReader::get_module_address(const char* module_name)
{
...
void MemoryReader::print_4_byte_hex(DWORD number)
{
